...
- スコア、レベル、コンボ、RUSH、ライフ、タブを閉じるまで残るベストスコア表示
- コイン、シールド、ライフ回復、RUSHスターアイテム
- ニアミス、ジャンプ回避、シールド防御でコンボとRUSHゲージが伸びるスコアシステム
- 小さなボーナス条件を順番に達成して報酬を得るミッション要素
- レベル9999まで伸びる、速度、出現間隔、複数レーン封鎖が激しくなる難易度カーブ
